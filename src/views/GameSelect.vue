    ...
    <section class="GameSelectSection mt-4">
        <div class="container-fluid">
            <div class="row">
                ...
                <!-- NF 以for渲染-->
                <div class="col-9 container-fluid ItemFrame">
                    <div class="card Charpter mb-4 px-0">
                    <div class="card-body">

                        <h5 class="card-title mb-3">Title Of The Charpter</h5>

                        <div class=" GameFrameGroup p-0 m-0 d-flex justify-content-start" style="overflow-x: auto; white-space: nowrap;">
                            <!-- NF 需要以for 渲染 -->
                                <div class="card GameCard mx-2 mb-2" style="width: 200px !important; flex-shrink: 0">
                                <div class="card-body">
                                    <img src="../assets/images/pics/cover_info.jpeg" class="card-img-top" alt="...">
                                    <p class="h5 card-title mt-2">遊戲標題</p>
                                    <p class="card-text">這是假文字</p>
                                </div>   
                                </div>
                    ...
                    <div class="card Charpter mb-4 px-0" style="overflow-y: auto;">
                    <div class="card-body">
